...
### What is CernVM-FS?
   ...
   The SFT group is part of CERN focuses on providing common software for scientific experiments. The description of CernVM File System is taken from [CERN SFT GSoC 2015 Ideas page][web3].
